...
// Store bundles the three repositories sharing one *sql.DB. Useful
...
// NewStore constructs all three repositories around db. The caller
// remains responsible for db.Close().
