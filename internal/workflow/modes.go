...
var presets = map[project.Mode]ModePreset{
	project.ModeAssessment: {
		...
		RecommendedTools: map[Phase][]string{
			...
			PhaseAssetDiscovery: {"crtsh", "subfinder", "amass", "dnsx", "dnsrecon"},
			PhaseValidation:     {"httpx_probe", "gowitness", "dnsx", "naabu", "whatweb", "msf_smb_version", "msf_ssh_version"},
			PhaseExposure:       {"nuclei", "testssl", "wpscan", "ssh_audit", "msf_smb_enumshares", "msf_ftp_anonymous"},
			PhaseEnrichment:     {"whois", "tlsx", "cloud_bucket", "holehe", "searchsploit", "shodan", "censys", "hibp"},
		},
	...
	project.ModeBugBounty: {
		...
		RecommendedTools: map[Phase][]string{
			...
			PhaseAssetDiscovery: {"crtsh", "subfinder", "amass", "dnsx", "dnsrecon", "historical_urls"},
			PhaseValidation:     {"httpx_probe", "gowitness", "naabu", "whatweb", "msf_smb_version", "msf_ssh_version", "msf_rdp_scanner"},
			PhaseExposure:       {"nuclei", "katana", "testssl", "wpscan", "ssh_audit", "msf_smb_enumshares", "msf_ftp_anonymous", "msf_snmp_login", "msf_vnc_none_auth"},
			PhaseEnrichment:     {"whois", "tlsx", "cloud_bucket", "holehe", "searchsploit", "trufflehog", "shodan"},
		},
